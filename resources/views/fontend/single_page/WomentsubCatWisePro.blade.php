		...
		<!--content-->
			<div class="content">
				<div class="products-agileinfo">
						<h2 class="tittle">Women's {{ (@$WomSubWisePro['0']->subcategorys['sub_category'])?$WomSubWisePro['0']->subcategorys['sub_category']:"Not Found!!" }}</h2>
					<div class="container">
							...
							<div class="col-md-9 product-agileinfon-grid1 w3l">
								<div class="product-agileinfon-top">
									<div class="col-md-6 product-agileinfon-top-left">
										<img class="img-responsive " src="{{ asset('fontend/images/img1.jpg') }}" alt="">
									</div>
									<div class="col-md-6 product-agileinfon-top-left">
										<img class="img-responsive " src="{{ asset('fontend/images/img2.jpg') }}" alt="">
									</div>
									<div class="clearfix"></div>
								</div>
								...
								<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
									...
									@if(count($WomSubWisePro)>0)
									<div id="myTabContent" class="tab-content">
										<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
											<div class="product-tab">

                                           @foreach($WomSubWisePro as $w)
												<div class="col-md-4 product-tab-grid simpleCart_shelfItem">
													<div class="grid-arr">
														...
														<div class="women">
															<h6><a href="single.html">{{ $w->product_name }}</a></h6>
