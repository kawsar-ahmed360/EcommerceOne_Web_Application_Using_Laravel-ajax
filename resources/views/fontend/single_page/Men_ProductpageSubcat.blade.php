		...
		<!--content-->
			<div class="content">
				<div class="products-agileinfo">
						<h2 class="tittle">Men's {{ (@$MenSubproductPagee['0']->subcategorys['sub_category'])?$MenSubproductPagee['0']->subcategorys['sub_category']:"Product Not Found" }}</h2>
					<div class="container">
							...
							<div class="col-md-9 product-agileinfon-grid1 w3l">
								...
								<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
									...
									<li role="presentation"><a href="#profile" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile"><img src="{{ asset('fontend/images/menu.png') }}"></a></li>
									 ...
									 @if(count($MenSubproductPagee)>0) 
                                        <div id="myTabContent" class="tab-content">
										<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
											<div class="product-tab">

                                           @foreach($MenSubproductPagee as $w)
									 ...
									 @else
                                        <h1 style="color:red">Your Find Product Not Found!!!!</h1>
									 @endif
								</div>
							</div>
							<div class="clearfix"> </div>
