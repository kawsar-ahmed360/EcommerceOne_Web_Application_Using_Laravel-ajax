<div class="modal fade" id="brand_edite" tabindex="-1" style="display: none"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-body">
             ...
             <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('BrandEdte') }}" method="post" accept-charset="utf-8" id="BrandEdite">
                      @csrf
