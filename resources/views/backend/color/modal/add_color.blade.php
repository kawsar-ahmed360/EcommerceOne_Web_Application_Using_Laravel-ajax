<div class="modal fade" id="color_add" tabindex="-1" style="display: none"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-body">
             ...
             <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('ColorSave') }}" method="post" accept-charset="utf-8" id="ColorAdd">
                      @csrf
