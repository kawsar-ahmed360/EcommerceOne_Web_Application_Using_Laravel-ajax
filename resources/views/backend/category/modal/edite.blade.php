<div class="modal fade" id="cat_edite" tabindex="-1" style="display: none"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
      ...
      <div class="modal-body">
             ...
             <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('CategoryEdite') }}" method="post" accept-charset="utf-8" id="CatEdite">
                      @csrf
    ...
    <input type="hidden" name="CateoryId" id="CateoryId">
